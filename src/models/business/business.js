...
const BusinessSchema = new Schema({
  businessName: {
    type: String, trim: true, index: true, default: "",
  }, claimed: {
    ...
    type: String, enum: ["ACTIVE", "BLOCKED", "NOT_VERIFIED"], default: "ACTIVE",
  }, currentSubscription: {
    ...
    type: [openHoursSchema], default: [],
  }, menu: {
    type: [menuSchema], default: [],
  }, searchAutocomplete: {
    ...
    type: String, enum: ["MAIN", "SUB"], default: "MAIN",
  }, favoriteList: {
    type: [{
