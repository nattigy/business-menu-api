...
const UserMutation = {
  ...
  ownerSignIn: UserTC.getResolver("ownerSignIn", [middleware.isGuest]),
  userSignUp: UserTC.getResolver("userSignUp", [middleware.isGuest, validator.signUp]),
  ownerSignUp: UserTC.getResolver("ownerSignUp", [middleware.isPhoneVerified, middleware.isGuest, validator.signUp]), // adminSignUp: UserTC.getResolver('adminSignUp', [validator.signUp]),
  ...
  updateUser: UserTC.getResolver("updateUser", [middleware.isAuth, validator.updateUser]), // switchLocale: UserTC.getResolver('switchLocale', [middleware.isAuth])
};
